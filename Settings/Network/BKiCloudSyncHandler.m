...
NSString *BKiCloudContainerIdentifier = @"iCloud.cloud.dissent.blinkshell";
...
//  CKDatabase *database = [[CKContainer containerWithIdentifier:@"iCloud.cloud.dissent.blinkshell"]privateCloudDatabase];
